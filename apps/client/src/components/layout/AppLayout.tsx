...
export const AppLayout = ({ hideControls, children }: AppLayoutProps) => (
  <div className="bg-content1 max-h-screen overflow-hidden">
    ...
    {children}
    {!hideControls && (
      <div className="pb-safe-offset-4 px-safe-offset-5 bg-content1/40 dark:bg-content1/80 h-26 fixed bottom-0 z-50 grid w-full grid-cols-3 items-center pt-4 shadow-[0_0_16px_0_rgba(0,0,0,0.25)] backdrop-blur lg:bg-transparent lg:shadow-none lg:backdrop-blur-none lg:dark:bg-transparent">
